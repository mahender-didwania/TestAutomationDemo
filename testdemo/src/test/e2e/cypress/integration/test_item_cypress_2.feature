...
Feature: Cypress - Scenario Outline Add
  ...
  Scenario Outline: Add a new item
  ...
  Scenario: Cypress - Scenario Outline Update // deliberately left outline to show the test runs fine without it, though not recommended to do so, demo purpose only
    Given I am on the item list page
